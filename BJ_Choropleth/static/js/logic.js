...
legend.onAdd = function (map) {
  ...
  let div = L.DomUtil.create('div', 'info legend');
      div.innerHTML +=
      '<i style="background:' + "#253494" + '"></i> ' + "55 - 120" + "<br>" +
      '<i style="background:' + "#2c7fb8" + '"></i> ' + "23 - 55" + "<br>" +
      '<i style="background:' + "#41b6c4" + '"></i> ' + "8 - 23" + "<br>" +
      '<i style="background:' + "#7fcdbb" + '"></i> ' + "-7 | -8" + "<br>" +
      '<i style="background:' + "#c7e9b4" + '"></i> ' + "-23 | -7" + "<br>" +
      '<i style="background:' + "#ffffcc" + '"></i> ' + "-64 | -23"
